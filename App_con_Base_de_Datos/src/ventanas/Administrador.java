...
public class Administrador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(label_register, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, -1, -1));

        label_manage.setForeground(new java.awt.Color(255, 255, 255));
        label_manage.setText("Gestionar Usuario");
        getContentPane().add(label_manage, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, -1, -1));

        label_creativity.setForeground(new java.awt.Color(255, 255, 255));
        label_creativity.setText("Creatividad");
        getContentPane().add(label_creativity, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 170, -1, -1));

        label_capturer.setForeground(new java.awt.Color(255, 255, 255));
        label_capturer.setText("Panel Vista Capturiata");
        getContentPane().add(label_capturer, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, -1, -1));

        label_technical.setForeground(new java.awt.Color(255, 255, 255));
        label_technical.setText("Panel Vista Tecnico");
        getContentPane().add(label_technical, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 340, -1, -1));

        label_about.setForeground(new java.awt.Color(255, 255, 255));
        label_about.setText("Acerca de");
        getContentPane().add(label_about, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 340, -1, -1));
